...
#if !defined( CACHE_H_20032006 )
#define CACHE_H_20032006
...
/* Describe the status of cache. */
typedef enum {
   CACHE_VALID = (1<<0),  /* in hash list normally */
   CACHE_FREE  = (1<<1),  /* in free list */
   CACHE_DIRTY = (1<<2),  /* in dirty list */
