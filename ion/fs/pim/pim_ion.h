...
/* ------------------------------- Global Funtions ------------------------------- */
int32_t pim_setup_ion( pim_devinfo_t *de, char * name );
int32_t pim_ioctl_ion( int32_t dev_id, pim_ioctl_cmd_t cmd, void *arg );
int32_t pim_readsector_ion( int32_t dev_id, uint32_t sect_no, uint8_t *buf, uint32_t cnt );
int32_t pim_writesector_ion( int32_t dev_id, uint32_t sect_no, uint8_t *buf, uint32_t cnt );
int32_t pim_erasesector_ion( int32_t dev_id, uint32_t sect_no, uint32_t cnt );
