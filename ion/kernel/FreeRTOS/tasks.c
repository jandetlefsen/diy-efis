 ...
 *
 * The portTASK_FUNCTPROTO() macro is used to allow port/compiler specific
 * language extensions.  The equivalent prototype for this function is:
 *
 * void prvIdleTask( void *pvParameters );
 *
 */
static portTASK_FUNCTPROTO( prvIdleTask, pvParameters );
...
#endif /* configUSE_APPLICATTASK_TAG */
/*-----------------------------------------------------------*/
