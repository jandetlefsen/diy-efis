...
#define tskKERNEL_VERSNUMBER "V8.2.3"
#define tskKERNEL_VERSMAJOR 8
#define tskKERNEL_VERSMINOR 2
#define tskKERNEL_VERSBUILD 3
...
static const TaskParameters_t xCheckTaskParameters =
{
	...
	// for full information.
	{
        ...
        { cReadWriteArray,				32,		portMPU_REGREAD_WRITE },
        { cReadOnlyArray,				32,		portMPU_REGREAD_ONLY },
        { cPrivilegedOnlyAccessArray,	128,	portMPU_REGPRIVILEGED_READ_WRITE }
	}
};
...
{
	// Base address		Length		Parameters
	{ ucOneKByte,		1024,		portMPU_REGREAD_WRITE },
	{ 0,				0,			0 },
	{ 0,				0,			0 }
};
...
they are explicitly required by the configUSE_APPLICATTASK_TAG configuration
constant. */
#ifdef configUSE_APPLICATTASK_TAG
	#if configUSE_APPLICATTASK_TAG == 1
		/**
		 * task.h
	...
	#endif /* configUSE_APPLICATTASK_TAG ==1 */
#endif /* ifdef configUSE_APPLICATTASK_TAG */
